...
public class Servidor extends JFrame implements ServicoRMI {

	final int PORTA_TCPIP = 1818;

	private ServicoRMI servico;
	...
	protected void iniciaServico() {
			...
			try {
				...
				textArea.append("Aguardando Conex�es\n");
	...
	public void registrar(String nome, ICliente cliente) throws RemoteException {
		...
		if(!listaOnline.containsKey(nome)){
			...
			cliente.reportError("Nome de usu�rio j� cadastrado");
		}
	}
